...
# TEXT
cfg.TEXT = edict()
cfg.TEXT.ENABLE = False
cfg.TEXT.MODEL_NAME = "roberta-base"
cfg.TEXT.MAX_LEN = 256
cfg.TEXT.SUBJECT_CLASSIFIER = True
cfg.TEXT.PROJ = False
cfg.TEXT.DROPOUT = 0.1
cfg.TEXT.CACHE = True
cfg.TEXT.FUSE = "cross_attn"
cfg.TEXT.NUM_HEADS = 4
cfg.TEXT.GATE_MODE = "scalar"
cfg.TEXT.FREEZE = False
cfg.TEXT.FUSION_LAYERS = 2
cfg.TEXT.TOKEN_LENGTH = 32
cfg.TEXT.FUSE_STAGES = "1"
cfg.TEXT.FUSE_MEMORY = False
cfg.TEXT.MEMORY_ALPHA = 0.5
cfg.TEXT.MEMORY_WARMUP = 0
cfg.TEXT.SUSTAIN_FUSION = False
cfg.TEXT.FP16 = False

# TRAIN
cfg.TRAIN = edict()
cfg.TRAIN.STAGE = 1 # 1: Visual only, 2: Text/Fusion
cfg.TRAIN.LR = 0.0001
...
cfg.TRAIN.SCHEDULER.T_MAX = 300  # 余弦退火周期
cfg.TRAIN.SCHEDULER.ETA_MIN = 1e-6  # 学习率最小值
cfg.TRAIN.SCHEDULER.WARMUP_EPOCHS = 10  # warmup阶段的epoch数量
cfg.TRAIN.SCHEDULER.WARMUP_START_LR = 1e-6  # warmup起始学习率
cfg.TRAIN.SCHEDULER.WARMUP_EPOCH = 5  # Added for compatibility
cfg.TRAIN.SCHEDULER.WARMUP_FACTOR = 0.01 # Added for compatibility
# DATA
cfg.DATA = edict()
cfg.DATA.MAX_JUMP = 8
cfg.DATA.SAMPLER_MODE = "consecutive"  # sampling methods
cfg.DATA.MEAN = [0.485, 0.456, 0.406]
cfg.DATA.STD = [0.229, 0.224, 0.225]
cfg.DATA.MAX_SAMPLE_INTERVAL = 200
cfg.DATA.PROCESSING_MODE = "frame_by_frame"
# DATA.TRAIN
