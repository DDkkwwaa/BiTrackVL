        ...
        for i in range(num_tries):
            try:
                ...
                for epoch in range(self.epoch+1, max_epochs+1):
                    ...
                    # Ensure all processes wait for the checkpoint to be saved and validation to finish
        ...
        for key in fields:
            ...
            if key == 'net':
                ...
                try:
                    ...
                    print(f"[Info] Optimizer structure changed (likely due to Text Module split).")
                    print(f"       Original error: {e}")
                    print("       Action: Loaded model weights successfully, but resetting optimizer state to adapt to new groups.")
            else:
